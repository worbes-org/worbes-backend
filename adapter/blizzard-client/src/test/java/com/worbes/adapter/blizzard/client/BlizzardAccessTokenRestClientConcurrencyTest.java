...
public class BlizzardAccessTokenRestClientConcurrencyTest {
    ...
    @Mock
    private BlizzardApiProperties configProvider;
    ...
    @BeforeEach
    void setUp() {
        given(configProvider.getTokenKey()).willReturn(TOKEN_KEY);
    ...
    void shouldOnlyRefreshOnceInMultiThreadedAccess() throws InterruptedException {
        ...
        then(restApiClient).should(times(1))
                .post(any(RestApiRequest.class), eq(BlizzardTokenResponse.class));
