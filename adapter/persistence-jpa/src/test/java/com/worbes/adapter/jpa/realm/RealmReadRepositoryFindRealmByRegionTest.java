...
class RealmReadRepositoryFindRealmByRegionTest {
    ...
    class HappyCases {
        ...
        void findByRegion_returnsRealms() {
            ...
            // when
            List<Realm> result1 = findRealmPort.findByRegion(kr);
            List<Realm> result2 = findRealmPort.findByRegion(us);
    ...
    class EdgeAndFailCases {
        ...
        void findByRegion_returnsEmptyWhenNone() {
            ...
            // when
            List<Realm> result = findRealmPort.findByRegion(RegionType.KR);
            // then
        ...
        void sameSlugOrConnectedRealmIdDifferentRegion() {
            ...
            List<Realm> krResult = findRealmPort.findByRegion(RegionType.KR);
            List<Realm> usResult = findRealmPort.findByRegion(RegionType.US);
