...
public class AuctionCommandRepositoryUpdateEndedAtByTest {
    ...
    @Autowired
    private UpdateAuctionPort auctionCommandRepository;
    ...
    class HappyCases {
        ...
        void onlyMatchingAuctionsAreEnded() {
            ...
            // when
            Long updated = auctionCommandRepository.updateEndedAt(region, realmId, idsToEnd);
            entityManager.clear();
        ...
        void endsAuctionsWithNullRealmId() {
            ...
            // when
            Long updated = auctionCommandRepository.updateEndedAt(region, null, Set.of(10L, 11L));
            entityManager.clear();
    ...
    class EdgeAndFailCases {
        ...
        void returnsZeroWhenNoMatchingAuctions() {
            ...
            // when
            Long updated = auctionCommandRepository.updateEndedAt(RegionType.US, 111L, Set.of(20L));
