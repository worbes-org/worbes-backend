...
class RealmReadRepositoryFindRealmSlugByRegionTest {
    ...
    class HappyCases {
        ...
        void findSlugByRegion_returnsOnlyMatchingRegion() {
            ...
            Set<String> result = findRealmPort.findSlugByRegion(RegionType.KR);
    ...
    class EdgeCases {
        ...
        void sameSlugDifferentRegion() {
            ...
            Set<String> krResult = findRealmPort.findSlugByRegion(RegionType.KR);
            Set<String> usResult = findRealmPort.findSlugByRegion(RegionType.US);
