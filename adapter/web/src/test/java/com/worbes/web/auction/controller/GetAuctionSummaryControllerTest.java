...
@WebMvcTest(GetAuctionSummaryController.class)
class GetAuctionSummaryControllerTest {
    ...
    @MockBean
    private GetAuctionSummaryUseCase getAuctionSummaryUseCase;
    ...
    void returnsOkWithValidParameters() throws Exception {
        ...
        Item item = Item.builder()
                ...
                .build();
        AuctionSummary auctionSummary = new AuctionSummary(item, 123456L, 5);
        given(getItemUseCase.get(any())).willReturn(List.of(item));
        given(getAuctionSummaryUseCase.getSummary(any())).willReturn(List.of(auctionSummary));
