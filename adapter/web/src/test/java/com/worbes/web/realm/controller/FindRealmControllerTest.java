...
@WebMvcTest(FindRealmController.class)
@DisplayName("Integration::FindRealmController")
class FindRealmControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @MockBean
    private FindRealmByRegionUseCase findRealmByRegionUseCase;
    ...
    void returnsOkWithValidRegionParameter() throws Exception {
        // given
        given(findRealmByRegionUseCase.findByRegion(any()))
