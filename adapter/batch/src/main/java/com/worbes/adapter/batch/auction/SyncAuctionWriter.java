...
public class SyncAuctionWriter implements ItemWriter<Auction>, StepExecutionListener {
    ...
    public void write(Chunk<? extends Auction> chunk) {
        ...
        int updatedOrInsertedAuctions = syncAuctionUseCase.execute(chunkedAuction);
