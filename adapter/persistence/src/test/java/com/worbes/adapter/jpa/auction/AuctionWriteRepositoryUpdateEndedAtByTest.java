...
@Transactional
public class AuctionWriteRepositoryUpdateEndedAtByTest {
    ...
    class HappyCases {
        ...
        void onlyMatchingAuctionsAreEnded() {
            ...
            // when
            Long updated = auctionWriteRepository.updateEndedAtBy(region, realmId, idsToEnd);
            entityManager.clear();
        ...
        void endsAuctionsWithNullRealmId() {
            ...
            // when
            Long updated = auctionWriteRepository.updateEndedAtBy(region, null, Set.of(10L, 11L));
            entityManager.clear();
    ...
    class EdgeAndFailCases {
        ...
        void returnsZeroWhenNoMatchingAuctions() {
            ...
            // when
            Long updated = auctionWriteRepository.updateEndedAtBy(RegionType.US, 111L, Set.of(20L));
